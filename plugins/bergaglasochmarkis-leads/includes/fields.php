...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'bergaglasochmarkis-leads' ),
				'storm'       => __( 'Storm or hail damage', 'bergaglasochmarkis-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'bergaglasochmarkis-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'bergaglasochmarkis-leads' ),
				'not-sure'    => __( 'Vet inte än', 'bergaglasochmarkis-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'bergaglasochmarkis-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'bergaglasochmarkis-leads' ),
				'research' => __( 'Jag kollar bara priser', 'bergaglasochmarkis-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'bergaglasochmarkis-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'bergaglasochmarkis-leads' ),
		'contacted' => __( 'Kontaktad', 'bergaglasochmarkis-leads' ),
		'quoted'    => __( 'Quote sent', 'bergaglasochmarkis-leads' ),
		'won'       => __( 'Won', 'bergaglasochmarkis-leads' ),
		'lost'      => __( 'Lost', 'bergaglasochmarkis-leads' ),
		'spam'      => __( 'Misstänkt spam', 'bergaglasochmarkis-leads' ),
	);
}
