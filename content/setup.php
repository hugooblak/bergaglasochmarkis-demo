<?php
/**
 * Demo site setup for Berga glas och markis.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Berga glas och markis' );
...
$home = nps_page(
	...
	nps_pattern( 'bergaglasochmarkis/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'bergaglasochmarkis/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'bergaglasochmarkis/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'bergaglasochmarkis/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'bergaglasochmarkis/thank-you' ),
...
<p class="has-large-font-size">Berga glas och markis är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Berga glas och markis', $about_content . "\n\n" . nps_pattern( 'bergaglasochmarkis/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'bergaglasochmarkis/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Berga glas och markis uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Berga glas och markis demo ready.' );
