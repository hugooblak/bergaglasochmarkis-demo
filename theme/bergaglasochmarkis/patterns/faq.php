...
?>
<!-- wp:group {"align":"full","className":"be-sec-faq","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group alignfull be-sec-faq" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:columns {"align":"wide","verticalAlignment":"top","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|70"}}}} -->
...
<p class="has-ink-soft-color has-text-color">Hittar du inte svaret? Ring oss på <a href="tel:<?php echo esc_attr( be_lead( 'telefon_tel' ) ); ?>"><?php echo esc_html( be_lead( 'telefon' ) ); ?></a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
foreach ( $faqs as $f ) :
	?><!-- wp:details {"className":"be-faq-item"} -->
<details class="wp-block-details be-faq-item"><summary><?php echo esc_html( $f[0] ); ?></summary><!-- wp:paragraph {"textColor":"ink-soft"} -->
